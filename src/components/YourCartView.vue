...
<script setup>
import {  ref } from 'vue';
import ConfirmationOrderModalView from './ConfirmationOrderModalView.vue';
    ...
    const emit = defineEmits(["remove","closeModal"])
